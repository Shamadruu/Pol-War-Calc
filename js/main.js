    ...
    city: {
        ...
        updateCityInfo: function() {
            $("#cities").find(".city").each(function() {
                ...
                $(this).find("div.row.pop").html('<div class="col-sm-3 header">Population</div><div class=col-sm-3 pop>' + c.pop + '</div><div class="col-sm-3 header">Population Density</div><div class="col-sm-3 popDensity">' + c.popDensity.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div>');
