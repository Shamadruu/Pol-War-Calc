    ...
    city: {
        ...
        updateCityInfo: function() {
            $("#cities").find(".city").each(function() {
                ...
                $(this).find("div.row.power").html('<div class="col-sm-3 header">Powered?</div><div class="col-sm-3 powered">' + c.powered + '</div><div class="col-sm-3 header">Power Capacity</div><div class="col-sm-3 powerSupply">' + c.powerSupply.replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div>');
