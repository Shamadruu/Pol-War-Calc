//Politics & War Calculator - Version 0.53 - Shamadruu
//(function() {
var main = {
    display: {},
    nation: {},
...
main.display = {
    ...
    nation: {
        genNationConfig: function() {
            var HTML = '<div class="row"><div class="col-sm-3 header">Alliance Tax Rate</div><div class="col-sm-3"><input id="allianceTaxRate" name="tax" type="number" min="0" max="100" value="' + (main.nation.inputData.taxRate * 100).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '">%</div><div class="col-sm-3 header">Total Income Bonus</div><div class="col-sm-3"><input id="nationBonus" name="bonus" type="number" min="0" max="100" value="' + main.nation.inputData.colorBonus + '">%</div></div><div class="row"><div class="col-sm-3 header">War? </div><div class="col-sm-3"><input type="checkbox" name="war" id="war"></div><div class="col-sm-3 header">Starving?</div><div class="col-sm-3"><input type="checkbox" name="starve" id="starve"></input></div></div>';
            return HTML;
        },
        ...
        genNationOverview: function() {
            var HTML = '<div class="row"><div class="col-sm-3 header">Cities</div><div class="col-sm-3">' + main.nation.data.cityCount + '</div><div class="col-sm-3 header">Improvements Built</div><div class="col-sm-3">' + main.nation.data.slotsUsed + '/' + main.nation.data.totalSlots + '</div></div><div class="row"><div class="col-sm-3 header">Infrastructure</div><div class="col-sm-3">' + main.nation.data.infra.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Land</div><div class="col-sm-3">' + main.nation.data.land.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div><div class="row"><div class="col-sm-3 header">Average Infrastructure</div><div class="col-sm-3">' + main.nation.data.avgInfra.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Average Land</div><div class="col-sm-3">' + main.nation.data.avgLand.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div><div class="row"><div class="col-sm-3 header">Population</div><div class="col-sm-3">' + main.nation.data.pop.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Population Density</div><div class="col-sm-3">' + (main.nation.data.pop / main.nation.data.land).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div><div class="row"><div class="col-sm-3 header">Average Population</div><div class="col-sm-3">' + main.nation.data.avgPop.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Average Pop Density</div><div class="col-sm-3">' + main.nation.data.avgPopDensity.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div><div class="row"><div class="col-sm-3 header">Weighted Average Income</div><div class="col-sm-3">$' + main.nation.data.wAvgIncome.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Tax Rate</div><div class="col-sm-3">' + main.nation.inputData.taxRate * 100 + '%</div></div><div class="row"><div class="col-sm-3 header">Average Disease</div><div class="col-sm-3">' + main.nation.data.avgDisease.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div><div class="col-sm-3 header">Average Crime</div><div class="col-sm-3">' + main.nation.data.avgCrime.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div></div><div class="row"><div class="col-sm-3 header">Average Pollution</div><div class="col-sm-3">' + main.nation.data.avgPollution.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Cities Powered Ratio</div><div class="col-sm-3">' + (main.nation.data.poweredRatio * 100).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div></div><div class="row"><div class="col-sm-3 header">Gross Revenue</div><div class="col-sm-3">$' + main.nation.data.revenue.money.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Net Income</div><div class="col-sm-3">$' + main.nation.data.revenue.money.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div><div class="row"><div class="col-sm-3 header">Production</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.coal.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.oil.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.uranium.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.lead.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.iron.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.bauxite.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.gasoline.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.munitions.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.steel.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.aluminum.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + main.nation.data.revenue.food.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div><div class="col-sm-3 header">Consumption</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.coal.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.oil.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.uranium.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.lead.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.iron.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.bauxite.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.gasoline.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.munitions.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.steel.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.aluminum.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + main.nation.data.revenue.food.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div></div></div><div class="row"><div class="col-sm-3 header">Net Revenue</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.coal.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.oil.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.uranium.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.lead.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.iron.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.bauxite.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.gasoline.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.munitions.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + main.nation.data.revenue.steel.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + main.nation.data.revenue.aluminum.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + main.nation.data.revenue.food.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div><div class="col-sm-6"></div></div>';
            return HTML;
        },
        genCityOverview: function() {
            ...
            for (var i = 0; i < main.nation.data.cities.length; i++) {
                ...
                HTML += '<div class="row" style="text-align: right;"><div class="col-sm-2 header" style="text-align: left;">' + c.displayName + '</div><div class="col-sm-1">' + c.infra.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-1">' + c.land.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-1">' + c.slotsUsed + '/' + c.slots + '</div><div class="col-sm-2">' + c.pop.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-2">$' + c.revenue.money.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3"><div class="col-sm-3 np" style="width: 100%; text-align: right"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + c.revenue.coal.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.oil.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.uranium.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.lead.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.iron.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.bauxite.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.gasoline.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.munitions.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.steel.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.aluminum.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + c.revenue.food.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div></div></div>';
            }
            return HTML;
        },
    ...
    city: {
        ...
        updateCityInfo: function() {
            $("#cities").find(".city").each(function() {
                ...
                $(this).find("div.row.pop").html('<div class="col-sm-3 header">Population</div><div class=col-sm-3 pop>' + c.pop.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">Population Density</div><div class="col-sm-3 popDensity">' + c.popDensity.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div>');
                $(this).find("div.row.ill").html('<div class="col-sm-3 header">Disease</div><div class="col-sm-3 disease">' + c.disease.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div><div class="col-sm-3 header">Crime</div><div class="col-sm-3 crime">' + c.crime.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div></div>');
                $(this).find('div.row.poll').html('<div class="col-sm-3 header">Pollution</div><div class="col-sm-3 pollution">' + c.pollution + '</div><div class="col-sm-3 header">Pollution Contribution</div><div class="col-sm-3 pollToll">' + c.pollToll.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div></div>');
                $(this).find("div.row.power").html('<div class="col-sm-3 header">Powered?</div><div class="col-sm-3 powered">' + c.powered + '</div><div class="col-sm-3 header">Power Capacity</div><div class="col-sm-3 powerSupply">' + c.powerSupply.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div>');
                $(this).find("div.row.inc").html('<div class="col-sm-3 header">Commerce</div><div class="col-sm-3 commerce">' + c.commerce + '</div><div class="col-sm-3 header">Average Income</div><div class="col-sm-3 avgIncome">$' + c.avgIncome.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div></div>');
                $(this).find("div.row.rev").html('<div class="col-sm-3 header">Gross Revenue (City)</div><div class="col-sm-3 grossRevenue">$' + c.revenue.money.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '</div><div class="col-sm-3 header">% National Revenue</div><div class="col-sm-3 perGrossRevenue">' + (c.revenue.money.prod / main.nation.data.revenue.money.prod * 100).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '%</div></div>');
                $(this).find("div.row.prod").html('<div class="col-sm-3 header">Production</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + c.revenue.coal.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.oil.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.uranium.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.lead.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.iron.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.bauxite.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.gasoline.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.munitions.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.steel.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.aluminum.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + c.revenue.food.prod.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div><div class="col-sm-3 header">Consumption</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + c.revenue.coal.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.oil.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.uranium.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.lead.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.iron.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.bauxite.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.gasoline.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.munitions.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.steel.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.aluminum.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + c.revenue.food.cons.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div>');
                $(this).find("div.row.net").html('<div class="col-sm-3 header">Net Revenue</div><div class="col-sm-3 np"><div class="container-fluid nb" style=font-size:12px><div class=row><div class="col-sm-3 nb np">' + c.revenue.coal.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/coal.png title=Coal style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.oil.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/oil.png title=oil style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.uranium.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/uranium.png title=Uranium style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.lead.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/lead.png title=Lead style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.iron.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/iron.png title=Iron style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.bauxite.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/bauxite.png title=Bauxite style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.gasoline.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/gasoline.png title=Gasoline style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.munitions.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/munitions.png title=Munitions style=width:12px;height:12px></div></div><div class=row><div class="col-sm-3 nb np">' + c.revenue.steel.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/steel.png title=Steel style=width:12px;height:12px></div><div class="col-sm-3 nb np">' + c.revenue.aluminum.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/aluminum.png title=Aluminum style=width:12px;height:12px></div><div class="col-sm-6 nb np">' + c.revenue.food.net.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px></div></div></div></div><div class="col-sm-3 header">City Worth</div><div class="col-sm-3" style="text-align: right;">' + c.cityCost.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/money.png title=Money style=width:12px;height:12px></div>');
    ...
    military: {
        genDisplay : function(){
            ...
            for(var m in main.nation.data.military){
                ...
                HTML += '</div></div></div><div class="col-sm-3" style="text-align: center;">$' + (main.nation.data.military[m].peaceUpkeep*main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
                if(m == "soldiers"){
                    HTML += ' ' + (1/750 * main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px>';
                }
                HTML += '</div><div class="col-sm-3" style="text-align: center;">$' + (main.nation.data.military[m].warUpkeep*main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
                if(m == "soldiers"){
                    HTML += ' ' + (1/500 * main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px>';
                }
                HTML += '</div></div></div>';
            }
            return HTML;
        ...
        updateMili: function(){
            for(var m in main.nation.data.military){
                ...
                HTML += '</div></div></div><div class="col-sm-3" style="text-align: center; height: 2em;">$' + (main.nation.data.military[m].peaceUpkeep*main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
                if(m == "soldiers"){
                    HTML += '  &  ' + (1/750 * main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px>';
                }
                HTML += '</div><div class="col-sm-3" style="text-align: center; height: 2em;">$' + (main.nation.data.military[m].warUpkeep*main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,");
                if(m == "soldiers"){
                    HTML += '  &  ' + (1/500 * main.nation.data.military[m].amount).toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1,") + '<img src=https://politicsandwar.com/img/resources/food.png title=Food style=width:12px;height:12px>';
                }
                HTML += '</div>';
